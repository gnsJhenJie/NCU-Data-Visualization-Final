...
function drawMap(topo) {
    ...
    let mouseOver = function(e) {
        ...
        if (countryData["Other Services"] === undefined){
            ...
            var newdata = [
                { "values": countryData.Children, "property": "Children" },
                { "values": countryData.Youth, "property": "Youth" },
                { "values": countryData.Adult, "property": "Adult" },
                { "values": countryData.Elderly, "property": "Elderly" }
            ]
...
function preprocess(d){
    return {
        ...
        //pie data
        'Children' : parseFloat(d['Children, aged 0-14']),
        'Youth' : parseFloat(d['Youth, aged 15-24']),
        'Adult' : parseFloat(d['Adult, aged 25-64']),
        'Elderly' : parseFloat(d['Elderly, aged 65+']),
    }
};
